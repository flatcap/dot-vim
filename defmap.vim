...
source ~/.config/nvim/defmap_file.vim
...
" nmap <Space>k     <Plug>(quickhl-manual-this)
" xmap <Space>k     <Plug>(quickhl-manual-this)

nmap <Space>k     <Plug>(quickhl-manual-this-whole-word)
xmap <Space>k     <Plug>(quickhl-manual-this-whole-word)

nmap <Space>K     <Plug>(quickhl-manual-reset)
xmap <Space>K     <Plug>(quickhl-manual-reset)

vmap <Space>k     <Plug>(quickhl-manual-this)

nmap <Space><C-k> <Plug>(quickhl-manual-toggle)
